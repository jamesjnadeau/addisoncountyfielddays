...
1. Entry fee — $2.00 per class. Enter online. Entries must be returned by Saturday, July 30, {{config.year}}.
...
entries between noon and 9:00 pm. on Monday, August {{config.monday}}, {{config.year}}. After check in,
only scratches can be made. Animals must remain in the grounds until 9:00 pm. on
Saturday, August {{config.saturday}}, {{config.year}}. All animals must be removed by 10:00 am. Sunday, August
15,2021. Exhibitors are responsible for taking down and stacking their own pens and
cleaning their area.
4. Barn Meeting for all exhibitors Tuesday, August {{config.friday}}th at 6:00 pm. in the
Show Tent.
...
prior to August {{config.tuesday}}, {{config.year}} and must have a certificate to verify the vaccination. All sheep
...
All premiums will be presented at the exhibitors meeting at 6:00 pm. on Saturday, August {{config.saturday}},{{config.year}}.
...
Entry due Tuesday, August {{config.tuesday}}, year. 
...
5. Exhibitor name, address, age as of January 1, {{config.year}} and contest entered must be
...
8. All entries must be received by 8:00 a.m. Tuesday,August {{config.tuesday}}, {{config.year}} and picked up Saturday, August {{config.saturday}},
{{config.year}} after 9:00 p.m.
...
Days, votes will be tallied and awarded on Saturday, August {{config.saturday}}, {{config.year}} at the Awards
Potluck at 6:00 p.m
...
7. Submit commentaries for judges by Saturday, August {{config.saturday}}, {{config.year}}.
...
2. Senior (18-21 years of age as of Jan. 1, {{config.year}}), Intermediate (13-17 years) and Junior
(8-12 years) classes.
