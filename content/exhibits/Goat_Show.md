...
3. Entries must be returned by Friday, July 26, {{config.year}}. Enter each class online at https://sites.google.com/view/acffdgoatshow/home
4. Exhibitors must provide their own feed and bedding. 
   ...
   area.
5. Barn Meeting for all exhibitors Tuesday, August {{config.tuesday}} at 6:00 p.m. in the Show Tent.
...
1. All goats must have health certificates and MUST be free of visual
   ...
   scrapie ear tag.
2. The show will take place on Wednesday, August {{config.wednesday}}, {{config.year}} at 12noon. Both youth and open
...
3. Senior Buck Class — born on or after September 1, {{config.year}} and before January 1, {{config.year}}
4. Junior Buck Class — born on or after January 1, {{config.year}}
   Champion Doe
5. Senior Doe—2 years and older
6. Yearling Doe — 1 year of age, but under 2 years
7. Senior Doe — born on or after September 1, {{config.year}} and before January 1, {{config.year}}
8. Junior Doe — born on or after January 1, {{config.year}}
